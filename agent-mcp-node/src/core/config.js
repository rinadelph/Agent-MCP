...
export const CHAT_MODEL = "gpt-4o-2024-11-20";
export const TASK_ANALYSIS_MODEL = "gpt-4o-2024-11-20";
export const MAX_EMBEDDING_BATCH_SIZE = 100;
export const MAX_CONTEXT_TOKENS = 128000; // GPT-4o context window
export const TASK_ANALYSIS_MAX_TOKENS = 128000;
// Environment variables
export const OPENAI_API_KEY = process.env.OPENAI_API_KEY;
export const MCP_PROJECT_DIR = process.env.MCP_PROJECT_DIR;
...
export function getProjectDir() {
    if (!MCP_PROJECT_DIR) {
        console.error("CRITICAL: MCP_PROJECT_DIR environment variable is not set.");
