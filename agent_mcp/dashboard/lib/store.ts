...
interface DashboardState {
  currentView: 'overview' | 'agents' | 'tasks' | 'memories' | 'prompts' | 'system' | 'supply-chain'
  setCurrentView: (view: 'overview' | 'agents' | 'tasks' | 'memories' | 'prompts' | 'system' | 'supply-chain') => void
  isLoading: boolean
