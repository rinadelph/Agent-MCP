...
class ManufacturingSupplyChainAI:
    ...
    def handle_emergency_procurement(self):
        ...
        """
        # CRITICAL: Hardcoded negative balance yarns requiring IMMEDIATE procurement (Top 11)
        CRITICAL_NEGATIVE_YARNS = [
            ...
            {'yarn_id': 19020, 'description': '30/1 55/45 Recycled Poly/Cotton', 'critical_balance': -877.0, 'supplier': 'R BELDA LLORENS'},
            {'yarn_id': 18372, 'description': '1/150/36 100% Polyester Black', 'critical_balance': -724.8, 'supplier': 'DECA GLOBAL'},
            {'yarn_id': 18553, 'description': '28/1 80/20 Celliant/Polyester RS', 'critical_balance': -723.1, 'supplier': 'SPUNLAB'},
            {'yarn_id': 18770, 'description': '28/1 78/22 Modacrylic/Rayon FR', 'critical_balance': -719.8, 'supplier': 'SPUNLAB'},
        ]
